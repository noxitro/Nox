...
namespace nox
{
	namespace detail
	{
		void	CheckSingletonCreateInstance(void* instance_ptr, std::string_view type_name);
		void	CheckSingletonDeleteInstance(void* instance_ptr, std::string_view type_name);
	}

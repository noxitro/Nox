...
#define NOX_ATTR_DECLARATION(...)	\
	...
	namespace attr
	{
		//	リフレクションの種類
		//	1.	全てのクラスを対象にリフレクション
		//	2.	Reflectionを付けたもの、ReflectionObjectを継承したもの、NOX_REFLECTION_DECLAREを付けたものを対象にリフレクション
		//	3.	リフレクションをしない

		/// @brief		リフレクション対象外属性
		/// @details	システム属性
		class IgnoreReflection : public nox::reflection::IAttribute
		{
		};

		/// @brief		リフレクション対象として表明
		/// @details	システム属性
		class Reflection : public nox::reflection::IAttribute
		{

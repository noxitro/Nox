...
nox::util::ParallelExecuteCheckScope::ParallelExecuteCheckScope(nox::util::ParallelExecuteChecker& checker, Option option, const std::source_location location) :
	checker_(checker)
{
...
void nox::util::ParallelExecuteChecker::Enter(nox::util::ParallelExecuteCheckScope::Option option, const std::source_location& location)
{
	if (nox::os::atomic::Increment(ref_counter_) > 1)
	{
		if (option == nox::util::ParallelExecuteCheckScope::Option::SourceLocation)
		{
